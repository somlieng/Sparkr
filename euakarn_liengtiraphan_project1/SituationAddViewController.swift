//
//  SituationAddViewController.swift
...
class SituationAddViewController: UIViewController {
    
    var list: Situations! = Situations.sharedInstance
    ...
    @IBAction func addCreature(_ sender: UIButton) {
        ...
        list.situations.append(prompt)
        print(list.situations)
        print("Saved")
        characterText.text = ""
